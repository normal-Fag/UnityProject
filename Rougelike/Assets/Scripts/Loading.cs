            ...
            else
            {
                ...
                switch (characterID)
                {
                    ...
                    case 0:
                        ...
                        {
                            string saveStr = File.ReadAllText(Application.persistentDataPath + "/Save/saveRouge.txt");

                            SaveRouge saveRouge = JsonUtility.FromJson<SaveRouge>(saveStr);
                    ...
                    case 1:
                        ...
                        {
                            string saveStr = File.ReadAllText(Application.persistentDataPath + "/Save/saveWarrior.txt");

                            SaveWarrior saveWarrior = JsonUtility.FromJson<SaveWarrior>(saveStr);
                    ...
                    case 2:
                        ...
                        {
                            string saveStr = File.ReadAllText(Application.persistentDataPath + "/Save/savePriest.txt");
